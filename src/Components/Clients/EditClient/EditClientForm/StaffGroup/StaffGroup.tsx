...
const StaffGroup: FC<IStaffGroupProps> = ({ variantsArray, valuesArray, name, title, clientId, editMode = true }: IStaffGroupProps) => {
            ...
            <div className={c.chosen}>
                ...
                {valuesArray.length ? valuesArray.map((el, i) => {
                    ...
                    return <div className={c.manager} key={el}
                        ...
                        { editMode && <CrossIcon color='##734B4D' size='16' /> }
                    </div>
                })
                    :
