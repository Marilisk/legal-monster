...
const PopupHeader: FC<IPopupHeaderProps> = ({ title, 
    content, id, handleDelete }: IPopupHeaderProps) => {
    ...
    return <div className={c.container} id={id}>
        <div className={c.wrap}>
           ...
           {/*  <button onClick={setEditible} type='button'>
            ...
            <DeleteButton callBack={handleDelete} visible={!!handleDelete} color='#fff' />
